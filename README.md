...
![NoSQL](https://img.shields.io/badge/NoSQL-blueviolet?style=for-the-badge&logo=databricks&logoColor=white)
...
![CrewAI](https://img.shields.io/badge/🤖%20CrewAI-FF4B4B?style=for-the-badge)
![DeepAgents](https://img.shields.io/badge/DeepAgents-6F42C1?style=for-the-badge)
![ADK](https://img.shields.io/badge/ADK-AgentDevKit-orange?style=for-the-badge)

### 📁 Vector Databases
![Pinecone](https://img.shields.io/badge/Pinecone-27272E?style=for-the-badge&logo=pinecone)
...
* **Advanced RAG Pipeline**: Built a retrieval-augmented generation system using LangChain, Pinecone, and OpenAI to query private PDF datasets with high precision.
* Computer Vision Classifier: Designed and trained a deep learning–based defect detection system for mechanical components using PyTorch.
